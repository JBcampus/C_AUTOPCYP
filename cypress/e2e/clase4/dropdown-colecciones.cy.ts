describe("Dropdown - selectores avanzados y colecciones", () => {
  ...
  it("debería validar opciones usando colecciones", () => {
    cy.get("#dropdown option").should("have.length.at.least", 3);

    //cuando dos elementos se ven separados por espacio en css, el 1ro es elemento padre y el 2do es el elemento HTML actual
