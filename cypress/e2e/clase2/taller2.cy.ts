...
cy.visit("/inputs");
cy.contains("h1", "Web inputs page for Automation Testing Practice").should("be.visible",); //la pagina contenga dicho texto y sea visible
});
...
dateInput.should("have.value", "12345");
});